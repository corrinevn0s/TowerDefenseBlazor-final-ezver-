...
public abstract class Enemy
{
    ...
    public int MaxHP { get; set; } // Добавляем максимальное ХП для полоски
    ...
    {
        X = x; Y = y; HP = hp; MaxHP = hp; Speed = speed; GoldReward = reward; Color = color;
    }
...
{
    public FastEnemy(float x, float y) : base(x, y, 15, 3.5f, 15, "orange") { }
}
